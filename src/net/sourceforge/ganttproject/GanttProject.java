...
public class GanttProject
	...
	public JMenuItem miNew, miOpen, miOpenURL, miSave, miSaveAs, miSaveAsURL, miExport, miImport, /*
																									 * miOpenDB,
																									 * miSaveAsDB,
																									 */
	...
	public GanttProject(String filename, boolean isApplet) {
		...
		tabpane.addTab(language.getText("gantt"), new ImageIcon(getClass().getResource("/icons/tasks_16.gif")),
				splitPane);
		tabpane.addTab(language.getText("human"), new ImageIcon(getClass().getResource("/icons/res_16.gif")),
				getResourcePanel());
	...
	public void applyButtonOptions() {
		...
		if (options.getButtonShow() == GanttOptions.TEXT) {
			...
			bOpen.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/open_" + options.getIconSize() + ".gif")));
			bSave.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/save_" + options.getIconSize() + ".gif")));
			bSaveAs.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/saveas_" + options.getIconSize() + ".gif")));
			bImport.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/import_" + options.getIconSize() + ".gif")));
			bExport.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/export_" + options.getIconSize() + ".gif")));
			bPrint.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/print_" + options.getIconSize() + ".gif")));
			bNewTask.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/insert_" + options.getIconSize() + ".gif")));
			bDelete.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/delete_" + options.getIconSize() + ".gif")));
			bProperties.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/properties_" + options.getIconSize() + ".gif")));
			bUnlink.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/unlink_" + options.getIconSize() + ".gif")));
			bLink.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/link_" + options.getIconSize() + ".gif")));
			bInd.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/indent_" + options.getIconSize() + ".gif")));
			bUnind.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/unindent_" + options.getIconSize() + ".gif")));
			bUp.setDefaultIcon(new ImageIcon(getClass().getResource("/icons/up_" + options.getIconSize() + ".gif")));
			bDown.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/down_" + options.getIconSize() + ".gif")));
			bPrev.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/prev_" + options.getIconSize() + ".gif")));
			bNext.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/next_" + options.getIconSize() + ".gif")));
			bZoomOut.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/zoomm_" + options.getIconSize() + ".gif")));
			bZoomIn.setDefaultIcon(
					new ImageIcon(getClass().getResource("/icons/zoomp_" + options.getIconSize() + ".gif")));
		}
	...
	public void addButtons(JToolBar toolBar) {
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////
		bNew = new TestGanttRolloverButton(
				new ImageIcon(getClass().getResource("/icons/new_" + options.getIconSize() + ".gif")));
		bNew.addActionListener(this);
		toolBar.add(bNew);
		///////////////////////////////////////////////////////////////////////////////////////////////////////////
		bOpen = new TestGanttRolloverButton(
				new ImageIcon(getClass().getResource("/icons/open_" + options.getIconSize() + ".gif")));
		bOpen.addActionListener(this);
		toolBar.add(bOpen);
		///////////////////////////////////////////////////////////////////////////////////////////////////////////
		bSave = new TestGanttRolloverButton(
				new ImageIcon(getClass().getResource("/icons/save_" + options.getIconSize() + ".gif")));
		...
		toolBar.add(bExport);
		///////////////////////////////////////////////////////////////////////////////////////////////////////////
		bPrint = new TestGanttRolloverButton(
				new ImageIcon(getClass().getResource("/icons/print_" + options.getIconSize() + ".gif")));
		...
		myNewArtefactAction = new NewArtefactAction(new NewArtefactAction.ActiveActionProvider() {
			public AbstractAction getActiveAction() {
				return tabpane.getSelectedIndex() == 0 ? (AbstractAction) myNewTaskAction
		...
		toolBar.add(bUp);
		///////////////////////////////////////////////////////////////////////////////////////////////////////////
		bDown = new TestGanttRolloverButton(
				new ImageIcon(getClass().getResource("/icons/down_" + options.getIconSize() + ".gif")));
		...
		toolBar.addSeparator(new Dimension(20, 0));
		///////////////////////////////////////////////////////////////////////////////////////////////////////////
		bPrev = new TestGanttRolloverButton(
				new ImageIcon(getClass().getResource("/icons/prev_" + options.getIconSize() + ".gif")));
		...
		toolBar.add(bPrev);
		///////////////////////////////////////////////////////////////////////////////////////////////////////////
		bNext = new TestGanttRolloverButton(
				new ImageIcon(getClass().getResource("/icons/next_" + options.getIconSize() + ".gif")));
		...
		toolBar.add(bNext);
		///////////////////////////////////////////////////////////////////////////////////////////////////////////
		bZoomOut = new TestGanttRolloverButton(
				new ImageIcon(getClass().getResource("/icons/zoomm_" + options.getIconSize() + ".gif")));
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////
		bZoomIn = new TestGanttRolloverButton(
				new ImageIcon(getClass().getResource("/icons/zoomp_" + options.getIconSize() + ".gif")));
		...
		for (int i = 0; i < cdmtn.length - 1; i++) {
			if (cdmtn[i] != null && cdmtn[i + 1] != null) {
				...
				try {
					...
					// e1.printStackTrace(); //To change body of catch statement use File | Settings
					// | File Templates.
				}
			}
		}
	...
	private void doExport(ExportFileInfo info) {
		switch (info.myFormat) {
			...
			case ExportFileInfo.FORMAT_PDF: {
				try {
					DeprecatedProjectExportData exportData = new DeprecatedProjectExportData(info.myFile.toString(),
							this, tree, area, getResourcePanel().area, info.myStorageOptions, getXslFo());
	...
	public void refreshProjectInfos() {
		if (tree.nbTasks == 0 && resp.nbPeople() == 0)
			...
			statusBar.setSecondText(correctLabel(language.getText("task")) + " : " + tree.nbTasks + "  " +
	...
	private static void usage() {
		...
		System.out
				.println(
						"    [project_file_name] a XML file based on ganttproject format to directly open (project.xml or project.gan)");
		System.out
				.println(
						"    -html [project_file_name] [export_directory_name], export directly a ganttproject file to web pages");
		System.out
				.println(
						"         -xsl-dir [xsl_directory]                        localisation of the xsl directory for html export");
		System.out
				.println(
						"    -pdf  [project_file_name] [pdf_file_name],         export directly a ganttproject file to web pages");
		System.out
				.println(
						"         -xsl-fo [xsl_fo_file]                           localisation of the xsl-fo file for pdf export");
		System.out
				.println(
						"    -csv  [project_file_name] [csv_image_filename],    export directly a ganttproject file to csv document compatible with spreadsheets");
		System.out
				.println(
						"    -png  [project_file_name] [png_image_filename],    export directly a ganttproject file to png image");
		System.out
				.println(
						"    -jpg  [project_file_name] [jpg_image_filename],    export directly a ganttproject file to jpg image");
		System.out
				.println(
						"    -fig/-xfig  [project_file_name] [fig_image_filename],    export directly a ganttproject file to xfig image");
		System.out.println();
		System.out
